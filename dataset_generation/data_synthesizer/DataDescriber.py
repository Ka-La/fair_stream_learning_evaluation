...
class DataDescriber:
    ...
    def describe_dataset_in_correlated_attribute_mode(self,
        ...
        set_root_attribute: String
            Root attribute for the distribution, is otherwise chosen randomly
        seed : int or float
        ...
        self.bayesian_network = greedy_bayes(self.df_encoded, k, epsilon / 2, seed=seed, set_root_attribute=set_root_attribute)
