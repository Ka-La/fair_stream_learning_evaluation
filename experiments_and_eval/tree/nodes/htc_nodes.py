...
from ..fair_splitter.nominal_splitter_classif import NominalSplitterClassif
...
class LeafMajorityClass(HTLeaf):
    ...
    def __init__(self, stats, depth, splitter, sens_att, sens_idx, trade_off=1, **kwargs):
        super().__init__(stats, depth, splitter, sens_att, sens_idx, trade_off=trade_off, **kwargs)

    @staticmethod
    def new_nominal_splitter(self):
        return NominalSplitterClassif(deprivedIndex=self.splitter.deprivedIndex)
