...
class HoeffdingAdaptiveTreeClassifier(HoeffdingTreeClassifier):
    ...
    def __init__(
        ...
        split_criterion: str = "fair_enhancing_info_gain",
        delta: float = 1e-7,
        tau: float = 0.05,
        ...
        remove_poor_attrs: bool = True, #According to paper, FEAT should remove poor attributes
    ...
    def _new_leaf(self, initial_stats=None, parent=None):
        ...
        return AdaLeafClassifier(
            ...
            stats=initial_stats,
            depth=depth,
            fairness_criteria="ignore_fairness",
        ...
        if not leaf.observed_class_distribution_is_pure():  # type: ignore
            ...
            if should_split:
                ...
                if split_decision.feature is None:
                    ...
                    kwargs['fairness_criteria'] = "ignore_fairness"
